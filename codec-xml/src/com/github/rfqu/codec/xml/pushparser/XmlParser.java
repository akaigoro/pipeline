 ...
 */
package com.github.rfqu.codec.xml.pushparser;

import com.github.rfqu.codec.scanner.ParseException;
import com.github.rfqu.codec.xml.builder.JsonBulderFactory;
import com.github.rfqu.codec.xml.builder.ListBuilder;
import com.github.rfqu.codec.xml.builder.MapBuilder;

public class XmlParser extends XmlScanner {
    protected final JsonBulderFactory factory;
    protected Parser currentParser;

    public XmlParser(JsonBulderFactory factory) {
